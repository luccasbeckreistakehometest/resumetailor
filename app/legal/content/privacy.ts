...
const en: LegalDoc = {
  ...
  sections: [
    ...
    { h: "2. What we collect", body: [{ list: [
      ...
      "Technical data: IP address (for security, abuse prevention and rate limits), essential cookies (see the Cookie Notice), and events from your first sessions (for example “made a kit”, “started the tour”) so we can improve the product.",
    ...
    { h: "3. Why we use it, and on what legal basis", body: [{ list: [
      ...
      "To understand how the product is used and improve it, using first-session events (legitimate interest). We do not sell data, show ads or build advertising profiles.",
    ...
    { h: "8. Cookies", body: ["We use only the cookies and browser storage the service needs to work (sign-in, your anonymous previews, a verified PIN, your language). No advertising or analytics cookies. Details are in the Cookie Notice."] },
...
const pt: LegalDoc = {
  ...
  sections: [
    ...
    { h: "2. O que a gente coleta", body: [{ list: [
      ...
      "Dados técnicos: endereço IP (pra segurança, prevenção de abuso e limites de uso), cookies essenciais (veja o Aviso de Cookies) e eventos das suas primeiras sessões (por exemplo “gerou um kit”, “começou o tour”) pra gente melhorar o produto.",
    ...
    { h: "3. Pra que a gente usa, e com qual base legal", body: [{ list: [
      ...
      "Entender como o produto é usado e melhorá-lo, com os eventos das primeiras sessões (legítimo interesse). A gente não vende dados, não mostra anúncios e não monta perfil publicitário.",
    ...
    { h: "8. Cookies", body: ["Usamos só os cookies e o armazenamento do navegador de que o serviço precisa pra funcionar (login, suas prévias anônimas, um PIN já verificado, seu idioma). Nada de cookies de publicidade ou de analytics. Os detalhes estão no Aviso de Cookies."] },
...
const es: LegalDoc = {
  ...
  sections: [
    ...
    { h: "2. Qué recogemos", body: [{ list: [
      ...
      "Datos técnicos: dirección IP (para seguridad, prevención de abusos y límites de uso), cookies esenciales (ver el Aviso de cookies) y eventos de tus primeras sesiones (por ejemplo “creó un kit”, “empezó el recorrido”) para mejorar el producto.",
    ...
    { h: "3. Para qué lo usamos y con qué base legal", body: [{ list: [
      ...
      "Entender cómo se usa el producto y mejorarlo con los eventos de las primeras sesiones (interés legítimo). No vendemos datos, no mostramos anuncios ni creamos perfiles publicitarios.",
    ...
    { h: "8. Cookies", body: ["Usamos solo las cookies y el almacenamiento del navegador que el servicio necesita para funcionar (inicio de sesión, tus vistas previas anónimas, un PIN ya verificado, tu idioma). Sin cookies publicitarias ni de analítica. Los detalles están en el Aviso de cookies."] },
