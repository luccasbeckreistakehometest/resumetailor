    ...
    <div className="min-h-screen">
      ...
      <Container className="grid items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
        <div>
          ...
          <p className="mt-4 text-sm"><Link href={to("ats")} className="font-medium text-oxblood underline-offset-4 hover:underline" data-testid="lp-ats">{d.lp.atsCta}</Link></p>
        </div>
