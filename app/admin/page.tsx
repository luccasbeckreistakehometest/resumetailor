        ...
        {data && (
          <>
            ...
            <div className="mt-4 overflow-x-auto">
              ...
              {tab === "users" && <Table cols={[x.admin.when, x.admin.email, "Nome", x.admin.credits, "Lang", "Last seen"]} rows={data.users.map((u) => [fmtDate(u.createdAt), u.email, u.name, u.credits, u.lang, fmtDate(u.lastSeenAt)])} />}
