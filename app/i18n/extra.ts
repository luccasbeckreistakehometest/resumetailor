 ...
 */
const en = {
  nav: { pricing: "Pricing", signIn: "Sign in", signOut: "Sign out", account: "Account", applications: "Applications", atsCheck: "ATS check" },
  credits: {
...
const pt: typeof en = {
  nav: { pricing: "Planos", signIn: "Entrar", signOut: "Sair", account: "Conta", applications: "Candidaturas", atsCheck: "Teste de ATS" },
  credits: {
...
const es: typeof en = {
  nav: { pricing: "Precios", signIn: "Entrar", signOut: "Salir", account: "Cuenta", applications: "Postulaciones", atsCheck: "Test ATS" },
  credits: {
    badge: (n: number) => `${n} crédito${n === 1 ? "" : "s"}`,
