...
const en = {
  ...
  personalisation: {
    ...
    locked: "Unlock the kit to go deeper on this posting.",
  ...
  letters: {
    title: "Cover letter", subtitle: "Same facts, four registers — pick the one that sounds like you and like the company.",
    tones: { original: "Original", formal: "Formal", warm: "Warm", direct: "Direct", confident: "Confident" },
    toneHint: { formal: "Banks, public sector, law, large corporations.", warm: "Startups, NGOs, education, healthcare.", direct: "Sales, operations, engineering — anyone reading 200 letters.", confident: "Owns the results and says what the first 90 days would look like." },
    rewriting: "Rewriting in that register…", writing: "Writing the email…", copy: "Copy", copied: "Copied ✓", cached: "Saved with the kit",
    emailsTitle: "Emails for the recruiter", emailsSubtitle: "Three moments where a short, specific email changes the outcome. Each is written from this kit and the posting.",
    kinds: { applied: "Right after applying", thanks: "Thank-you after the interview", nudge: "Polite nudge after silence" },
    kindHint: { applied: "Name the role, one reason, your strongest result.", thanks: "Within a day: one topic from the call, one strength.", nudge: "After a week of silence: interest, one new thing, the timeline." },
    subject: "Subject", openMail: "Open in my email app",
    placeholders: "Square brackets mark what only you know — the name, the date, the topic from the call. Fill them before sending.",
  },
  progress: {
    eyebrow: "Interview progress", title: "How your interviews are evolving",
    intro: "Every practice session, scored the same way, on one line. Where you got stronger, what still drags the score down, and what to rehearse next — no AI here, just your numbers.",
    empty: "No scored sessions yet. Open a kit, run the mock interview, and your trend starts here.",
    tiles: { sessions: "Sessions", latest: "Latest score", strongest: "Strongest", weakest: "Weakest" },
    answers: (n: number) => `${n} answer${n === 1 ? "" : "s"} scored`, sinceFirst: "since your first session",
    chartTitle: "Score per session", chartHint: "Overall score of each session, oldest to newest, across every kit.",
    nextTitle: "Next rehearsal", practise: (kit: string) => `Practise on “${kit}” →`,
    advice: {
      structure: "Your answers wander. Rehearse the shape out loud: one sentence of situation, one of task, what you did, what came of it — in that order, under 90 seconds.",
      specificity: "Your answers stay general. Pick three stories and attach a number to each — size, money, time saved, growth — and name the tool you used.",
      relevance: "Your answers drift from the question. Before answering, repeat the question's key word back, then pick the story that proves exactly that.",
    },
...
const pt: typeof en = {
  ...
  applications: {
    ...
    views: { board: "Quadro", table: "Tabela" },
  ...
  personalisation: {
    ...
    locked: "Libere o kit pra aprofundar nessa vaga.",
  ...
  letters: {
    title: "Carta de apresentação", subtitle: "Os mesmos fatos, quatro tons — escolhe o que soa como você e como a empresa.",
    tones: { original: "Original", formal: "Formal", warm: "Calorosa", direct: "Direta", confident: "Confiante" },
    toneHint: { formal: "Banco, setor público, jurídico, grande empresa.", warm: "Startup, ONG, educação, saúde.", direct: "Vendas, operações, engenharia — quem lê 200 cartas.", confident: "Assume os resultados e diz como seriam os primeiros 90 dias." },
    rewriting: "Reescrevendo nesse tom…", writing: "Escrevendo o e-mail…", copy: "Copiar", copied: "Copiado ✓", cached: "Guardado com o kit",
    emailsTitle: "E-mails pro recrutador", emailsSubtitle: "Três momentos em que um e-mail curto e específico muda o resultado. Cada um é escrito a partir deste kit e da vaga.",
    kinds: { applied: "Logo depois de se candidatar", thanks: "Agradecimento depois da entrevista", nudge: "Cobrança educada depois do silêncio" },
    kindHint: { applied: "Nomeia a vaga, um motivo, seu resultado mais forte.", thanks: "Em até um dia: um assunto da conversa, um ponto forte.", nudge: "Depois de uma semana sem resposta: interesse, uma novidade, o prazo." },
    subject: "Assunto", openMail: "Abrir no meu e-mail",
    placeholders: "O que está entre colchetes só você sabe — o nome, a data, o assunto da conversa. Preenche antes de mandar.",
  },
  progress: {
    eyebrow: "Evolução nas entrevistas", title: "Como suas entrevistas estão evoluindo",
    intro: "Cada treino, avaliado do mesmo jeito, numa linha só. Onde você ficou mais forte, o que ainda derruba a nota e o que ensaiar em seguida — sem IA aqui, só os seus números.",
    empty: "Nenhum treino avaliado ainda. Abre um kit, roda a entrevista simulada, e a sua evolução começa aqui.",
    tiles: { sessions: "Treinos", latest: "Última nota", strongest: "Ponto forte", weakest: "Ponto fraco" },
    answers: (n: number) => `${n} resposta${n === 1 ? "" : "s"} avaliada${n === 1 ? "" : "s"}`, sinceFirst: "desde o primeiro treino",
    chartTitle: "Nota por treino", chartHint: "Nota geral de cada treino, do mais antigo pro mais novo, em todos os kits.",
    nextTitle: "Próximo ensaio", practise: (kit: string) => `Treinar em “${kit}” →`,
    advice: {
      structure: "Suas respostas se perdem no caminho. Ensaia a forma em voz alta: uma frase de situação, uma de tarefa, o que você fez, o que deu — nessa ordem, em menos de 90 segundos.",
      specificity: "Suas respostas ficam genéricas. Escolhe três histórias e bota um número em cada uma — tamanho, dinheiro, tempo ganho, crescimento — e diz qual ferramenta usou.",
      relevance: "Suas respostas fogem da pergunta. Antes de responder, repete a palavra-chave da pergunta e escolhe a história que prova exatamente aquilo.",
    },
...
const es: typeof en = {
  ...
  personalisation: {
    ...
    locked: "Desbloquea el kit para profundizar en esta oferta.",
  ...
  letters: {
    title: "Carta de presentación", subtitle: "Los mismos hechos, cuatro registros — elige el que suena como tú y como la empresa.",
    tones: { original: "Original", formal: "Formal", warm: "Cálida", direct: "Directa", confident: "Segura" },
    toneHint: { formal: "Bancos, sector público, legal, grandes empresas.", warm: "Startups, ONG, educación, salud.", direct: "Ventas, operaciones, ingeniería — quien lee 200 cartas.", confident: "Asume los resultados y dice cómo serían los primeros 90 días." },
    rewriting: "Reescribiendo en ese registro…", writing: "Escribiendo el email…", copy: "Copiar", copied: "Copiado ✓", cached: "Guardado con el kit",
    emailsTitle: "Emails para el reclutador", emailsSubtitle: "Tres momentos en los que un email corto y específico cambia el resultado. Cada uno se escribe a partir de este kit y la oferta.",
    kinds: { applied: "Justo después de postular", thanks: "Agradecimiento tras la entrevista", nudge: "Recordatorio amable tras el silencio" },
    kindHint: { applied: "Nombra el puesto, una razón, tu resultado más fuerte.", thanks: "Dentro de un día: un tema de la charla, una fortaleza.", nudge: "Tras una semana sin respuesta: interés, algo nuevo, los plazos." },
    subject: "Asunto", openMail: "Abrir en mi correo",
    placeholders: "Lo que está entre corchetes solo lo sabes tú — el nombre, la fecha, el tema de la charla. Complétalo antes de enviar.",
  },
  progress: {
    eyebrow: "Progreso en entrevistas", title: "Cómo evolucionan tus entrevistas",
    intro: "Cada práctica, puntuada de la misma manera, en una sola línea. Dónde te hiciste más fuerte, qué sigue bajando el puntaje y qué ensayar después — sin IA aquí, solo tus números.",
    empty: "Aún no hay prácticas puntuadas. Abre un kit, corre la entrevista simulada, y tu progreso empieza aquí.",
    tiles: { sessions: "Prácticas", latest: "Último puntaje", strongest: "Punto fuerte", weakest: "Punto débil" },
    answers: (n: number) => `${n} respuesta${n === 1 ? "" : "s"} puntuada${n === 1 ? "" : "s"}`, sinceFirst: "desde tu primera práctica",
    chartTitle: "Puntaje por práctica", chartHint: "Puntaje general de cada práctica, de la más antigua a la más nueva, en todos los kits.",
    nextTitle: "Próximo ensayo", practise: (kit: string) => `Practicar en “${kit}” →`,
    advice: {
      structure: "Tus respuestas se pierden en el camino. Ensaya la forma en voz alta: una frase de situación, una de tarea, qué hiciste, qué resultó — en ese orden, en menos de 90 segundos.",
      specificity: "Tus respuestas quedan generales. Elige tres historias y ponle un número a cada una — tamaño, dinero, tiempo ahorrado, crecimiento — y nombra la herramienta que usaste.",
      relevance: "Tus respuestas se alejan de la pregunta. Antes de responder, repite la palabra clave de la pregunta y elige la historia que prueba exactamente eso.",
    },
