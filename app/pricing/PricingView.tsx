  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <Container className="max-w-5xl py-12 sm:py-16">
        ...
        {canceled && <p className="mt-6 rounded-xl border border-gold bg-gold-2 px-4 py-3 text-sm text-ink" role="status" data-testid="checkout-canceled">{l.pricing.canceled}</p>}
