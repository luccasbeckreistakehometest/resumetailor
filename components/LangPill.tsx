...
export function LangPill() {
  ...
  return (
    <div className="fixed left-1/2 top-[70px] z-[60] flex -translate-x-1/2 items-center gap-1 rounded-full border border-edge-2 bg-raised py-1 pl-4 pr-1 text-sm shadow-[var(--shadow-pop)]" data-testid="lang-pill">
