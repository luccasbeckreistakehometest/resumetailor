...
const ANCHORS = ["nav-start", "choose", "credits", "nav-library", "ats-check", "applications", "interview"];
const ROUTE_FOR: Record<string, string> = { "nav-start": "/", choose: "/start", credits: "/start", "nav-library": "/start", "ats-check": "/ats-check", applications: "/applications", interview: "/library" };
